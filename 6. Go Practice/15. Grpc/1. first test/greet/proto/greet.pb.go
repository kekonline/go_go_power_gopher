...
var file_greet_proto_rawDesc = []byte{
	...
	0x47, 0x72, 0x72, 0x65, 0x74, 0x12, 0x13, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72,
...
var file_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetService.Grret:input_type -> greet.GreetRequest
	1, // 1: greet.GreetService.Grret:output_type -> greet.GreetResponse
